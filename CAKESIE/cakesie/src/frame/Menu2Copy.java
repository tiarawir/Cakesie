 ...
 * @author tiara
 */
public class Menu2Copy extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Menu2Copy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
